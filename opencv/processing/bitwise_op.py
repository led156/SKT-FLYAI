...
image3 = cv2.bitwise_or(image1, image2) # 좌 흰 + 흰 원
image4 = cv2.bitwise_and(image1, image2) # 좌 반 흰 원
image5 = cv2.bitwise_xor(image1, image2) # (좌 흰 - 좌 반 흰 원) + 우 반 흰 원
image6 = cv2.bitwise_not(image1) # 흰 배경 + 검은 원
